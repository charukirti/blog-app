...
export default function AuthLayout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="flex items-center py-12 sm:px-6 lg:px-10">
        ...
        <section className="rounded-2xl border border-gray-100 bg-white px-6 py-8 shadow-xl sm:mx-auto sm:w-full sm:max-w-md dark:border-gray-800 dark:bg-gray-800">
          <Outlet />
